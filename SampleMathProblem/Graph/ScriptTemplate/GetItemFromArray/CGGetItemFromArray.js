...
const Graph_runtime_1 = require('../Utils/ScriptNodeAPI');
class CGGetItemFromArray extends Graph_runtime_1.BaseNode {
    constructor() {
        super();
    }
    clamp(value, min, max) {
    ...
    getOutput() {
        ...
        if (array[itemIndex] === null || array[itemIndex] === undefined) {
            return (0, Graph_runtime_1.getDefaultValue)((_a = this.valueType) !== null && _a !== void 0 ? _a : '');
        }
